...
<html>
    ...
    <body>
        ...
        <div class="nav" role="navigation">
            <ul>
                <li style="background-color: #7c7c7c"><g:link style="color: white" class="list" action="index">Lista de Contas</g:link></li>
                <li style="background-color: #7c7c7c"><g:link style="color: white" class="create" action="create">Nova Conta</g:link></li>
            </ul>
        </div>
        <div id="edit-contaBancaria" class="content scaffold-edit" role="main">
            ...
            <g:form resource="${this.contaBancaria}" method="PUT">
                <g:hiddenField name="version" value="${this.contaBancaria?.version}" />
                <fieldset class="form">
