...
<head>
    ...
    html {
        ...
        /*background-image: -moz-linear-gradient(center top, #ddd);*/
...
<body>
<a href="#list-contaBancaria" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
...
%{--<g:link class="create" style="color: white" action="create">--}%
%{--Nova Conta--}%
%{--</g:link>--}%
%{--</button>--}%
%{--</li>--}%
...
<div class="box box-primary direct-chat direct-chat-success">
    <div class="box-header with-border" style="background-color: #ecf0f5">
        <h3 class="box-title"><i class="fa fa-list"></i>&nbsp;<strong>Lista de Contas Bancarias</strong></h3>
    </div>

    <div class="box-body" style="padding: 8px; background-color: #fff">

        <div id="list-contaBancaria" class="content scaffold-list" role="main" style="background-color: #fff">
            <g:if test="${flash.message}">
                <div class="message" role="status">${flash.message}</div>
            </g:if>
            <f:table class="table table-bordered text-center table-striped" collection="${contaBancariaList}"/>

            <div class="row" style="margin: 0; padding: 0px">
                <div class="col-md-6" style="align-content: start">
                    <div class="pagination">
                        <g:paginate total="${contaBancariaCount ?: 0}"/>
                    </div>
                </div>
                ...
                <div class="col-md-6" style="align-content: end">
                    <div>
                        <button class="btn btn-primary btn-flat pull-right">
                            <g:link class="create" action="create" style="color: #fff">
                                Nova Conta
                            </g:link>
                        </button>
                    </div>
