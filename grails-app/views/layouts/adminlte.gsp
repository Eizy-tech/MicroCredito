...
<head>
  ...
  <![endif]-->
    ...
    <!-- formwizzard -->
    <asset:stylesheet src="formwizzard.css"/>
    <!-- Font Awesome -->
    %{--
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>EIZY</b>SYS</span>
        </a>
    ...
    <asset:image src="eizytecLogo.png" alt="EIZY LOGO" class="float-left"/><strong>Copyright &copy; 2019 <a href="http://eizytec.com">EIZY TECNOLOGY, Lda</a>.</strong> Todos direitos reservados
    reserved.
    </footer>
...
<!-- formwizzard -->
<asset:javascript src="formwizzard.js"/>
